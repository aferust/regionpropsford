module measure.eigen;

import std.math;
import std.algorithm.comparison;

import measure.types;
// based on Java code from https://github.com/fiji/Jama
 ...
 * ------------------------ */
   ...
   */
   private Mat2D!double V;

   /** Array for internal storage of nonsymmetric Hessenberg form.
   @serial internal storage of nonsymmetric Hessenberg form.
   */
   private Mat2D!double H;
 ...
 * ------------------------ */
   ...
   */
   ...
   public Mat2D!double getD () {
      auto D = Mat2D!double(n,n);
      for (int i = 0; i < n; i++) {
         for (int j = 0; j < n; j++) {
            D[i, j] = 0.0;
         }
